 ...
 * Date: 2021-06-18
 * Title: PacMan Game
 * Description: This application runs the classic PacMan game. PacMan is an action maze game where the player controls the 
 * pacMan creature to escape from the ghosts. The objective of the game is eat all of the pellets on the screen. If the
 * ghost comes in contact with pacman, it will kill pacman. This game provides with 3 chances(lives) to play the game.
 * It also keeps track of the highest scorers and displays it on the leaderboard.
 *
 * Added Features:
 ...
 * 
 * Areas of Concern:  - Instead of holding the keys to move, the user has to tap the keys to create the PacMan chomping sound 
 * 					because the sound effect is created when the key is tapped (not when it is held down continuously)
 * 
...
//This class is used to create a PacManGUI that will start a PacMan game
public class PacManGame {

	// FIELDS

	// Keeps track of the number of lives of pacMan
	public static int lives = 3;

	// Keeps track of whether the game is running or not
	public static boolean isGameRunning = false;

	// This File location contains all the scores and names of the users
	public static String highScoreFile = "highScoreFile.txt";

	// Keeps track of the user name
	public static String name;

	// Keeps track of whether the game is restarted already or not
	public static boolean restartGame = false;

	// ScoreCard object array which has a maximum limit of 100 scorecards (username,
	// score)
	public static ScoreCard scoresArray[] = new ScoreCard[100];

	// Main - Runs the application
	public static void main(String[] args) {

		// Call the HomeScreen GUI
		new HomeScreen();

	}

	// This method resets lives when the whole game is restarted and 3 games are
	// played
